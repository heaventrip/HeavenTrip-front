          ...
          if (key === 'placement') {
            switch (val) {
              case 'top':
                ...
                if (value.displayArrow || modifiers.arrow) {
                  targetEl.style.setProperty('--v-tooltip-arrow-border-color', 'var(--v-tooltip-background-color) transparent transparent transparent')
                  targetEl.style.setProperty('--v-tooltip-arrow-top', 'calc(var(--v-tooltip-top) - var(--v-tooltip-top-offset) + 8px)')
                }
                break
              case 'bottom':
                targetEl.style.setProperty('--v-tooltip-left', '50%')
                ...
                if (value.displayArrow || modifiers.arrow) {
                  targetEl.style.setProperty('--v-tooltip-arrow-border-color', 'transparent transparent var(--v-tooltip-background-color) transparent')
                  targetEl.style.setProperty('--v-tooltip-arrow-top', 'calc(var(--v-tooltip-top) - var(--v-tooltip-top-offset) - 7px)')
                }
                break
              case 'left':
                ...
                if (value.displayArrow || modifiers.arrow) {
                  targetEl.style.setProperty('--v-tooltip-arrow-border-color', 'transparent transparent transparent var(--v-tooltip-background-color)')
                  targetEl.style.setProperty('--v-tooltip-arrow-top', 'calc(var(--v-tooltip-top)')
                  targetEl.style.setProperty('--v-tooltip-arrow-left', 'calc( var(--v-tooltip-left) - var(--v-tooltip-left-offset) + 1.5px)')
                }
                break
              case 'right':
                ...
                if (value.displayArrow || modifiers.arrow) {
                  targetEl.style.setProperty('--v-tooltip-arrow-border-color', 'transparent var(--v-tooltip-background-color) transparent  transparent')
                  targetEl.style.setProperty('--v-tooltip-arrow-top', 'calc(var(--v-tooltip-top)')
                  targetEl.style.setProperty('--v-tooltip-arrow-left', 'calc( var(--v-tooltip-left) - var(--v-tooltip-left-offset) - 2px)')
                }
                break
              default:
                break
