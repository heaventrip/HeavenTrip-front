  ...
  <div>
    <div class="bg-dark text-white footer pt-5 pb-4">
      <div class="container">
        <div class="row">
          <div class="col-12 col-md-10 col-lg-5 mx-auto text-center">
            <p class="head para pt-3 pt-md-5 pt-lg-4">
              Besain d'un conseil au demande specifique ?<br />disponible <span class="font-weight-bold">7j / 7</span> de
        ...
        <hr />
        <div class="row">
          <div class="col-12 col-sm-6 col-lg-3 pl-lg-0 order-sm-2 order-lg-4 mb-5 mar-btm mb-lg-0">
          ...
          <div class="col-12 col-sm-6 col-lg-3 pr-md-5 order-sm-1 mb-5 mar-btm mb-lg-0">
          ...
          <div class="col-12 col-sm-6 col-lg-3 pr-md-5 order-sm-3 mb-5 mb-sm-0">
            <h3 class="text-uppercase border-bottom d-flex align-items-center pb-3 heading mb-4">
              partenaires
              <img class="mr-2 ml-auto" fluid :src="require('@/assets/images/star_white.png')" />
            </h3>
            <div id="" class="carousel slide partner" data-ride="carousel">
              <div class="carousel-inner">
                <div class="carousel-item active">
                  <img class="d-block mx-auto" fluid :src="require('@/assets/images/decath.png')" />
                </div>
                <div class="carousel-item">
                  <img class="d-block mx-auto" fluid :src="require('@/assets/images/logo.png')" />
                </div>
                <div class="carousel-item">
                  <img class="d-block mx-auto" fluid :src="require('@/assets/images/decath.png')" />
                </div>
          ...
          <div class="col-12 col-sm-6 col-lg-3 pr-lg-5 order-sm-4 order-lg-2 mb-0">
            <h3 class="text-uppercase border-bottom d-flex align-items-center pb-3 heading mb-4">
              creer ton stage
        ...
        <div class="row list-row">
          <div class="col-12 col-md-6 col-lg-3 pr-md-4 pr-lg-3 order-4 order-md-1 text-center text-md-left">
          ...
          <div class="col-12 col-md-5 col-lg-3 mb-md-5 d-none d-sm-block order-md-2">
            <div class="row">
              <div class="col-6">
          ...
          <div class="col-12 col-md-5 col-lg-3 pl-lg-0 order-md-3">
            <div class="row">
          ...
          <div class="col-12 col-md-7 col-lg-3 order-md-4">
            <div class="row">
              <div class="col-6 pl-md-5 pl-lg-0">
                <h5 class="text-uppercase list-head">service</h5>
                <ul class="list-unstyled">
                  <li><a href="#">Creer ton stage</a></li>
                  <li><a href="#">Demande personnalisee</a></li>
                  <li><a href="#">Comite d'entreprise</a></li>
        ...
        <div class="row">
          <div class="col-12 text-center mt-4">
            <ul class="list-unstyled mb-0 d-none d-sm-flex justify-content-center bottom-link-list">
              <li class="d-none d-lg-block">
                <a href="#">&copy; Tous droits reserves - Heaven Trip 2019 - 2020</a>
              </li>
              <li><a href="#">Conditions generales de vente</a></li>
              <li><a href="#">Conditions generales d'utilisations</a></li>
