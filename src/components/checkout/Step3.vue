<template>
  <div class="tab-pane fade" id="step3" role="tabpanel" aria-labelledby="step3-tab">
    <div class="preview-card border-0 d-none align-items-center text-uppercase flex-row bg-dark text-white px-5 rounded-lg mb-5">
      <span class="font-weight-light mr-5 ml-2">vous êtes 2 trippers</span>
    ...
    <div class="card d-none">
      <div class="card-header border-0 p-0 d-flex">
        <h6 class="mb-0 text-uppercase font-weight-normal d-flex align-items-center check-head px-5 p-4 flex-1">
          ...
          <strong class="participant-name h6 mb-0 font-weight-bold">marion <i class="fa fa-caret-right mx-3 small align-baseline caret-icon"></i></strong>
          ...
          <div class="ml-auto text-right check-amount-head">SEJOUR MARION<br /><strong class="check-amount d-block mt-1">2 220 &euro;</strong></div>
        </h6>
      </div>
      <div class="mx-5">
    ...
    <div class="card">
      <div class="card-header border-0 p-0 d-flex">
        <h6 class="mb-0 text-uppercase font-weight-normal d-flex align-items-center check-head px-5 p-4 flex-1">
          ...
          <strong class="participant-name h6 mb-0 font-weight-bold participant-opacity">marion <i class="fa fa-caret-right mx-3 small align-baseline caret-icon"></i></strong>
          <!-- marion -->
          <div class="participant-add position-relative d-flex align-items-center">
            <i class="far fa-user-circle mx-3 align-baseline participant-icon"></i>
            <strong class="participant-name h6 mb-0 font-weight-bold">AXEL </strong>
          </div>
          <div class="ml-auto text-right check-amount-head">SEJOUR AXEL<br /><strong class="check-amount d-block mt-1">2 220 &euro;</strong></div>
        </h6>
      </div>
      <div class="mx-5">
        <div class="reservation-text position-relative mt-4">
        ...
        <div class="card-body p-0 pt-5">
          ...
          <div class="custom-radio-container p-4 px-5 mr-5 pb-5">
            <div class="custom-control">
              <input type="radio" id="Radio1" name="room1" class="custom-control-input" disabled />
            ...
            <div class="custom-control">
              <input type="radio" id="Radio2" name="room1" class="custom-control-input" disabled />
            ...
            <div class="custom-control">
              <input type="radio" id="Radio3" name="room1" class="custom-control-input" checked="" />
              <label class="custom-control-label" for="Radio3">
                <div class="d-flex align-items-center pb-2 mb-2 dotted-border">
                  ...
                  <div class="ml-auto font-weight-bold text-uppercase">réservée par marion</div>
                </div>
              </label>
            </div>
            <div class="custom-control">
              <input type="radio" id="Radio4" name="room1" class="custom-control-input" disabled />
        ...
        <div class="card-body border-top p-0 pt-5">
          ...
          <div class="custom-radio-container p-4 px-5 mr-5 pb-5">
            <div class="custom-control">
              <input type="radio" id="Radio5" name="materiel1" class="custom-control-input" />
            ...
            <div class="custom-control">
              <input type="radio" id="Radio6" name="materiel1" class="custom-control-input" />
        ...
        <div class="card-body border-top p-0 pt-5">
          ...
          <div class="custom-radio-container inline-blocks py-3">
            <div class="custom-control custom-radio bg-light rounded border">
              <input type="checkbox" id="Radio7" class="custom-control-input" />
              <label class="custom-control-label d-flex align-items-center border-0" for="Radio7">
                <div class="font-weight-bold text-uppercase">
                  sup-paddle<span class="border-left">+ 60&euro;<small class="text-lowercase">/pers.</small></span>
                </div>
              </label>
            ...
            <div class="custom-control custom-radio bg-light rounded border">
              <input type="checkbox" id="Radio8" class="custom-control-input" />
              <label class="custom-control-label d-flex align-items-center border-0" for="Radio8">
                <div class="font-weight-bold text-uppercase">
                  plongee sous-marine<span class="border-left">+ 60&euro;<small class="text-lowercase">/pers.</small></span>
                </div>
              </label>
            ...
            <div class="custom-control custom-radio bg-light rounded border">
              <input type="checkbox" id="Radio9" class="custom-control-input" />
              <label class="custom-control-label d-flex align-items-center border-0" for="Radio9">
                <div class="font-weight-bold text-uppercase">
                  sup-paddle<span class="border-left">+ 60&euro;<small class="text-lowercase">/pers.</small></span>
                </div>
              </label>
            ...
            <div class="custom-control custom-radio bg-light rounded border">
              <input type="checkbox" id="Radio10" class="custom-control-input" />
              <label class="custom-control-label d-flex align-items-center border-0" for="Radio10">
                <div class="font-weight-bold text-uppercase">
                  sup-paddle<span class="border-left">+ 60&euro;<small class="text-lowercase">/pers.</small></span>
                </div>
              </label>
          ...
          <div class="col-12 p-0">
            <div class="custom-control custom-checkbox mb-0 other-activity-check mb-5 pl-0">
              <input type="checkbox" class="custom-control-input" id="exampleCheck4" />
              <label class="custom-control-label mb-0 pl-4" for="exampleCheck4">je ne souhaite pas d'autres activites</label>
            </div>
          </div>
        </div>
        <div class="card-body border-top p-0 pt-5">
