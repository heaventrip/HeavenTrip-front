  ...
  <div class="tab-pane fade" id="step3" role="tabpanel" aria-labelledby="step3-tab">
    ...
    <vue-collapsible-panel-group>
      <vue-collapsible-panel>
        <template #title>Participant 1</template>
        <template #content>
          <!-- NOTE booker -->
      ...
      <vue-collapsible-panel v-for="(extraParticipant, mainLoopIndex) in $parent.extraParticipants" :key="extraParticipant">
        <template #title>Participant {{ mainLoopIndex + 2 }}</template>
        <template #content>
          <!-- NOTE extras -->
          <div class="card d-block">
            <div class="card-header border-0 p-0 d-flex">
