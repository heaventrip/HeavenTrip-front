<template>
  <nav class="navbar navbar-expand-lg navbar-dark border-lg-0 main-navbar heaven-navbar">
    ...
    <div class="collapse navbar-collapse text-white" id="navbarSupportedContent">
      ...
      <div class="tab-content main-wrapper">
        <div id="pills-activites" role="tabpanel" aria-labelledby="pills-activites-tab" class="wrapper h-100 p-0 tab-wrapper tab-pane fade black pt-lg-5 home-wrapper custom-activities">
          <div class="container">
            <div class="row w-100 m-0">
              ...
              <div class="col-12 col-lg-9">
                <div class="tab-content wrapper-content" id="activites_pills_tabContent">
                  <div class="tab-pane fade" id="v-pills-vent-mer" role="tabpanel" aria-labelledby="v-pills-vent-mer-tab">
                    <h4 class="nav-head m-0">
                    ...
                    <div class="col-12 col-lg-8 ml-auto px-0 px-lg-3">
                      <div class="fprint-div">
                        ...
                        <div class="ml-2">
                          ...
                          <h2 class="concept-head">NOTRE <span class="font-weight-bold">CONCEPT</span></h2>
                        </div>
                      </div>
                    </div>
...
export default {
  ...
  mounted() {
    ...
    if (width < 692) {
      ...
      $('#activites_pills_tab.navbar-nav.mobile-navs .nav-link').on('click', function (e) {
        e.preventDefault()
        var in_forward_id = $(this).attr('href').split('=')
        $('.main-wrapper .tab-pane' + in_forward_id + '').addClass('active')
        $('#activites_pills').hide()
      })
      $('#agence_pills_tab.nav-pills.mobile-navs .nav-link').on('click', function (e) {
        e.preventDefault()
