  ...
  <div>
    <main>
      <section class="carousel-section">
        <div class="container">
          <div class="row">
            <div class="col-12 col-sm-10 col-lg-9 mx-auto border-lg-bottom">
              <center>
                <h2>Conditions generales d'utilisations</h2>
                <hr />
              </center>
            </div>
            ...
            <div class="col-12 col-sm-10 col-lg-9 mx-auto"></div>
            <div class="col-12 col-sm-10 col-lg-9 mx-auto">
              <p>
              ...
              <p>
                ...
                est reproduit ci-dessous pour les curieux. Les sections 1.10.32
                et 1.10.33 du "De Finibus Bonorum et Malorum" de Cicéron sont
                aussi reproduites dans leur version originale, accompagnée de la
                traduction anglaise de H. Rackham (1914).
              </p>
              <pre></pre>
            </div>
          </div>
