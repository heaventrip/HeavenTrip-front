    ...
    <div class="modal-dialog modal-dialog-centered login-modal profile-modal">
      <div class="modal-content border-0 rounded-0">
        <div class="modal-body p-0 border-0">
          ...
          <div class="modal-content-body bg-white d-none">
            <div class="text-center mobile-vh">
              <div class="centered-vh d-none">
                ...
                <form>
                  <div class="form-group">
                    <label class="form-label text-uppercase font-weight-bold mt-3 d-block">Quel camps ?</label>
              ...
              <div class="d-none">
                <h6 class="profile-head mt-5 mt-md-0">Tu verras, sur le site tu pourras voir les photos des intéressés et des participants. Sois pas timide et montre toi !</h6>
                <div class="upload-div">
                  <i class="align-text-top fa fa-arrow-circle-up"></i>
                </div>
                <p class="upload-text mb-1">Clique sur l’icône pour télécharger ta photo de profil</p>
                <p class="info-text-small">Taille maximum 1MB</p>
              </div>
              <div class="centered-vh">
                ...
                <div class="row">
                  <div class="col-12 col-lg-11 mx-auto">
                    ...
                    <p class="sub-text font-weight-normal text-left">Tu peux modifier à tout moment via ton espace client.</p>
                    <form>
