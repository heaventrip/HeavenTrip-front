<template>
  <div class="test">
    ...
    <ul>
      <li>données de contact et certificat médical du client ou des clients,</li>
      <li>données d’identification du client ou des clients, dont les données lui auront été communiquées par le ou les clients,</li>
      <li>données bancaires du ou des clients,</li>
      <li>pendant les Expéditions, les données de géolocalisation seront recueillies ;</li>
    </ul>
    <p>Les données collectées par la Société sont utilisées par les services idoines de ce dernier, en sa qualité de responsable du traitement, pour les finalités suivantes :</p>

    <p>dans le cadre du traitement, de l’exécution et du suivi de la commande du client et en particulier aux fins suivantes :</p>
    <ul>
      <li>création et gestion du compte du client ;</li>
      <li>traitement des demandes et des réservations du client ;</li>
      <li>suivi de l’exécution de la commande.</li>
    </ul>

    <p>Dans le cadre d’activités liées au fonctionnement des services proposés par la Société:</p>
    <ul>
      <li>amélioration des services proposés par la Société;</li>
      <li>suivi de la relation clientèle et recueil d’avis ;</li>
      <li>sollicitation commerciale réalisée par la Société pour des produits ou services analogues ;</li>
      <li>détection des activités frauduleuses ou des atteintes à la sécurité des services assurés par la Société et poursuites afférentes ;</li>
      <li>Géolocalisation pendant les expéditions afin de pouvoir porter assistance aux participants ;</li>
      <li>réponse à une demande de communication légale.</li>
    </ul>
    ...
    <p>Les traitements sont réalisés sur les bases juridiques suivantes :</p>
    <ul>
      <li>exécution d’un contrat entre le client et la société ;</li>
      <li>intérêts légitimes de la Société visant à traiter les réservations faites par un client pour les autres participants ;</li>
    ...
    <ul>
      ...
      <li>droit pour le client de définir ses directives relatives à la conservation, à l’effacement et à la communication de ses données à caractère personnel après son décès.</li>
    </ul>

    <p>Ces droits s’exercent par courriel à l’adresse suivante : hello@yourheaventrip.com.</p>

    <p>Le client peut également modifier ses données en se connectant à son compte client.</p>
