  ...
  <div v-else class="d-flex agency-content-wrapper flex-column justify-content-center">
    ...
    <div class="row justify-content-center bottom-text">
      ...
      <div class="text-center">
        Heaven Trip c'est pas juste une nouvelle agence de voyage, c'est la rencontre de deux passionnés qui veulent reconnecter les uns aux autres <br />à travers des expériences concentrées sur
        l'humain, et le dépassement de soi. Ici, on valorise ce que tu veux devenir et non ce que tu es.
      </div>
