<template>
  <div class="modal fade" id="pwd" tabindex="-1" aria-labelledby="pwdLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg login-modal pwd-modal">
            ...
            <div class="left-part">
              ...
              <div class="modal-content-body bg-white">
                <div class="d-none">
                  ...
                  <form>
                    <input class="form-control modal-input" type="text" name="" value="axel.sonderer@gmail.com" placeholder="Email" />
                    <a class="password-link d-block text-right" href="#">J’ai retrouvé mon mot de passe</a>
                    <button class="btn btn-dark btn-block text-uppercase border-0 rounded-0 modal-btn">Valider</button>
                  </form>
                </div>
                <div class="text-center d-none">
                  ...
                  <button class="btn btn-dark btn-block text-uppercase border-0 rounded-0 modal-btn sent">DEMANDE ENVOYée</button>
                </div>
                <div class="">
                ...
                <div class="text-center d-none">
                  ...
                  <button class="btn btn-dark btn-block text-uppercase border-0 rounded-0 modal-btn">SE CONNECTER</button>
                </div>
              </div>
            </div>
