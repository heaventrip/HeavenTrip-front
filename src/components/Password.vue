<template>
  ...
  >
    <div
      class="modal-dialog modal-dialog-centered modal-lg login-modal pwd-modal"
    >
      <div class="modal-content border-0 rounded-0">
        <div class="modal-body p-0 border-0">
          <div class="d-flex flex-column flex-lg-row">
              ...
              <div class="modal-content-body bg-white">
                <div class="d-none">
                  <p class="content-head">
                    Assure toi de renseigner un mail valide :
                  </p>
                  <form>
                    <input
                      ...
                      type="text"
                      name=""
                      value="axel.sonderer@gmail.com"
                      placeholder="Email"
                    />
                    <a class="password-link d-block text-right" href="#"
                      >J’ai retrouvé mon mot de passe</a
                    >
                    <button
                      class="btn btn-dark btn-block text-uppercase border-0 rounded-0 modal-btn"
                    >
                      Valider
                    </button>
                  </form>
                ...
                <div class="">
                  <p class="content-head">
                    Merci de saisir ton nouveau mot de passe :
                  </p>
                  <form>
                    <input
                      class="form-control modal-input"
                ...
                <div class="text-center d-none">
                  ...
                  <h6 class="info-text text-uppercase mt-3">
                    <strong class="text-danger d-block"
                      >Ton nouveau mot de passe a été enregistré.</strong
                    >
            ...
            <div class="right-part dark-content-body">
              <img
              ...
              />
              <img
                class="logo d-none d-lg-block mx-auto"
                fluid
                :src="require('@/assets/images/LOGO_FULL_WHITE.png')"
              />
              <img
                class="logo d-block mx-auto d-lg-none"
                fluid
                :src="require('@/assets/images/LOGO_N.png')"
              />
              <div class="separator-line"></div>
              <h6 class="profile-text">De l’évasion sportive pour tous !</h6>
              <ul
                class="list-unstyled modal-profile-list mb-0 d-flex justify-content-center ml-4"
              >
                <li>
                  <a href="#"
                    ><img
